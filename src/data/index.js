...
// 明确导出存储相关函数，避免命名冲突
export { saveUserInfo, getUserInfo, saveHealthData, getHealthData, saveHealthGoals, getHealthGoals, getCustomMetrics, saveCustomMetrics, exportData, importData, backupAllData, exportBackup, restoreBackup, getBackupSettings, saveBackupSettings, getBackupHistory, addBackupHistory, clearBackupHistory, checkScheduledBackup, performScheduledBackup } from './dataStorage.js';
// 导出数据加载函数
